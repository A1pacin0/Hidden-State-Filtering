...
from model.model_mistral import create_model  # Import the create_model function from model.py
...
def save_metrics_to_file(filepath, accuracy, f1, precision, recall, fixed_text):
...
def predict(args):
    ...
    save_metrics_to_file(args.output_file, accuracy, f1, precision, recall, args.fixed_text)
